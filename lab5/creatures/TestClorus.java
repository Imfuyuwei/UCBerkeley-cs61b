...
public class TestClorus {
    ...
    public void testReplicate() {
        Clorus c_1 = new Clorus(2);
        Clorus c_2 = c_1.replicate();
        assertEquals(1, c_1.energy(), 0.01);
        assertEquals(1, c_2.energy(), 0.01);
        Clorus c_3 = c_1.replicate();
        assertEquals(0.5, c_1.energy(), 0.01);
        assertEquals(0.5, c_3.energy(), 0.01);
    }
